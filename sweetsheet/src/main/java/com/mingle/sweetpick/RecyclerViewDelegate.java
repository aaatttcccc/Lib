...
public class RecyclerViewDelegate extends Delegate {
    ...
    protected View createView() {
        ...
        rootView.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View view, int keyCode, KeyEvent keyEvent) {
                if (keyCode == KeyEvent.KEYCODE_BACK
                    ...
                    RecyclerViewDelegate.super.dismiss();
                }
                return false;
            }
        });
        ...
        mTitle = (TextView) rootView.findViewById(R.id.nameTitle);
        mLlRV = (LinearLayout) rootView.findViewById(R.id.llRV);
...
//                        Animation animation = AnimationUtils.loadAnimation(mLlRV.getContext(), R.anim.gradually);
